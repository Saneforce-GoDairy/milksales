...
import com.saneforce.milksales.SFA_Adapter.GRN_Print_Invoice_Adapter;
...
public class GRN_Invoice extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI {
    ...
    List<com.saneforce.milksales.SFA_Model_Class.OutletReport_View_Modal> OutletReport_View_Modal = new ArrayList<>();
