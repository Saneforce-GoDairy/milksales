...
import static com.saneforce.milksales.SFA_Activity.HAPApp.setAppLogos;
...
import com.saneforce.milksales.SFA_Activity.PendingOutletsCategory;
...
//                  menuList.add(new ListModel("", "Inshop", "", "", "", R.drawable.ic_inshop));
    ...
    private void getNotify() {
        ...
        if (com.saneforce.milksales.Activity_Hap.Common_Class.isNullOrEmpty(mShared_common_pref.getvalue(Constants.DB_TWO_GET_NOTIFY))) {
