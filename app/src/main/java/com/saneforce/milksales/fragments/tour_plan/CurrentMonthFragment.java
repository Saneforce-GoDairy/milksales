...
public class CurrentMonthFragment extends Fragment implements Main_Model.MasterSyncView, View.OnClickListener, Master_Interface {
...
//                        }
        ...
        try {
            ...
            mCall.enqueue(new Callback<>() {
                ...
                public void onResponse(@NonNull Call<Object> call, @NonNull Response<Object> response) {
                    ...
                    //-------------- RecyclerView
                    adapter2 = new TourPlanCalanderAdapter(getActivity(), R.id.date, SelectedMonth + 1, year, (ArrayList<com.saneforce.milksales.Model_Class.Tp_View_Master>) Tp_View_Master);
                    ...
                    adapter3 = new TourPlanExploreAdapter(getActivity(), SelectedMonth + 1, year,(ArrayList<com.saneforce.milksales.Model_Class.Tp_View_Master>) Tp_View_Master);
    ...
    public class TourPlanCalanderAdapter extends RecyclerView.Adapter<TourPlanCalanderAdapter.ViewHolder>{
        ...
        private final String  curentDateString;
...
//            Log.e("color_", mColor);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder
        {
            ...
            private final RelativeLayout mDateLayout;
            private final CardView mTourPlanCircle;
        ...
        private void printMonth(int mm, int yy) {
            ...
            for (int i = 0; i < trailingSpaces; i++) {
                list.add((daysInPrevMonth - trailingSpaces + DAY_OFFSET) + i + "-GREY" + "-" + getMonthAsString(prevMonth) + "-" + prevYear);
            }
    ...
    public class GridCellAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        private final List<String> list;
        private final ArrayList<Tp_View_Master> Tp_View_Master;
        private static final int DAY_OFFSET = 1;
        private final String[] months = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
        private final int[] daysOfMonth = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
        private int daysInMonth;
