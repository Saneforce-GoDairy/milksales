...
import com.saneforce.godairy.SFA_Adapter.Outlet_Info_Adapter;
...
public class Reports_Outler_Name extends AppCompatActivity {
    ...
    List<com.saneforce.godairy.SFA_Model_Class.Retailer_Modal_List> Retailer_Modal_List = new ArrayList<>();
