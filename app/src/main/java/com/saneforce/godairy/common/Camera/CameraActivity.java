package com.saneforce.godairy.common.Camera;
...
public class CameraActivity extends Fragment {
  ...
  public interface CameraPreviewListener {
    void onPictureTaken(String originalPicture,String picData);
    ...
    public void onPictureTaken(byte[] data, Camera arg1){
      ...
      try {
       ...
       /*/ if (!storeToFile) {
          ...
          String path =getImgFilename();// getTempFilePath();
          FileOutputStream out = new FileOutputStream(path);
          out.write(data);
          out.close();
          String encodedImage = Base64.encodeToString(data, Base64.NO_WRAP);
          eventListener.onPictureTaken(path,encodedImage);
        //}
          Log.d(TAG, "CameraPreview pictureTakenHandler called back "+path);
