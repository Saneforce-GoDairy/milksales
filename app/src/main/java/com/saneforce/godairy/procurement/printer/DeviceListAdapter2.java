...
class DeviceListAdapter2 extends RecyclerView.Adapter<DeviceListAdapter2.Holder> {
    ...
    public DeviceListAdapter2(ArrayList<BluetoothDevice> bondedDevices, String mPrinterName) {
