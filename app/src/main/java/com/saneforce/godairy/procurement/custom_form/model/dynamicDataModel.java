...
public class dynamicDataModel {
    ...
    public dynamicDataModel(String id, String data, String tag, int mandatory){
        this.column = id;
        this.data = data;
        this.tag = tag;
        this.mandatory = mandatory;
    }
    public dynamicDataModel(String fldSrcName,String fldSrcFld){
        this.fldSrcName=fldSrcName;
        this.fldSrcFld=fldSrcFld;

    }

    public dynamicDataModel(int id,String moduleNm){
        this.moduleId=id;
