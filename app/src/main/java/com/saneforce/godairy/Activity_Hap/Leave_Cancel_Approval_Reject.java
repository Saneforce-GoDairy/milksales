            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (flag == 1) {
                        ...
                        Toast.makeText(getApplicationContext(), "CancelLeave Rejected  Successfully", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.Lapprovebutton:
                SendtpApproval("LeaveCancelApproval", 1);
                break;
            case R.id.Lreject:
            ...
            case R.id.L_rejectsave:
                if (reason.getText().toString().equalsIgnoreCase("")) {
                    ...
                    SendtpApproval("LeaveCancelReject", 2);
                }
                break;
