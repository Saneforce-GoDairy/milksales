...
//            if (edtTo.getText().toString() != null && !edtTo.getText().toString().isEmpty() && !edtTo.getText().toString().equals("null")) {
        ...
        inEdtFrom = Integer.valueOf(com.saneforce.godairy.Activity_Hap.Common_Class.isNullOrEmpty(edtFrom.getText().toString()) ? "0" : edtFrom.getText().toString().equalsIgnoreCase("null") ? "0" : edtFrom.getText().toString());
        inEdtTo = Integer.valueOf(com.saneforce.godairy.Activity_Hap.Common_Class.isNullOrEmpty(edtTo.getText().toString()) ? "0" : edtTo.getText().toString().equalsIgnoreCase("null") ? "0" : edtTo.getText().toString());
