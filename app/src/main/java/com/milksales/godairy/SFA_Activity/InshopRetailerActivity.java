...
import static com.milksales.godairy.Common_Class.Constants.DELIVERY_SEQUENCE;
...
public class InshopRetailerActivity extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI {
    ...
    public void reloadData() {
        try {
            ...
            if (Retailer_Modal_ListFilter != null) {
                ...
                recyclerView.setAdapter(new InshopRetailerAdapter(Retailer_Modal_ListFilter, R.layout.inshop_retailer_list, this, "Outlets", new AdapterOnClick() {
                    @Override
                    public void onIntentClick(int position) {
                        try {
                            Intent intent = new Intent(getApplicationContext(), InshopCheckinActivity.class);
...
//                        Toast.makeText(InshopRetailerActivity.this,"posdsfdghfghfgg",Toast.LENGTH_SHORT).show();
//
//                        return false;
//                    }
//
...
//
////                        Toast.makeText(InshopRetailerActivity.this,"posdsfdfgg",Toast.LENGTH_SHORT).show();
//
//                    }
//
//                    @Override
