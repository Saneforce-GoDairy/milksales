...
import static com.milksales.godairy.SFA_Activity.HAPApp.CurrencySymbol;
import static com.milksales.godairy.SFA_Activity.HAPApp.MRPCap;
import static com.milksales.godairy.SFA_Activity.HAPApp.StockCheck;
...
import com.milksales.godairy.SFA_Adapter.RyclListItemAdb;
import com.milksales.godairy.SFA_Model_Class.Category_Universe_Modal;
import com.milksales.godairy.SFA_Model_Class.ComplementaryInvoiceModel;
import com.milksales.godairy.SFA_Model_Class.Product_Details_Modal;
import com.milksales.godairy.Status_Adapter.ComplementaryInvoiceAdapter;
...
public class CompementaryInvoiceActivity extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI, Master_Interface {
    ...
    CompementaryInvoiceActivity.Prodct_Adapter mProdct_Adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.activity_compementary_invoice);

            db = new DatabaseHandler(this);
            sharedCommonPref = new Shared_Common_Pref((Activity) context);
            ...
            showInvoiceList.setEnabled(false);
            ...
            showInvoiceList.setOnClickListener(v -> {
    ...
    private void GetJsonData(String jsonResponse, String type, String filter) {
        ...
        try {
            ...
            if (type.equals("1")) {
                ...
                CompementaryInvoiceActivity.CategoryAdapter customAdapteravail = new CategoryAdapter(getApplicationContext(),
                        Category_Modal);
        ...
        switch (v.getId()) {
            case R.id.btnRepeat:
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        common_class.getDataFromApi(Constants.PreInvOrderQty, CompementaryInvoiceActivity.this, false);
                    }
                }, 500);
                break;
    ...
    private void SaveOrder() {
        if (common_class.isNetworkAvailable(this)) {
            ...
            AlertDialogBox.showDialog(CompementaryInvoiceActivity.this, HAPApp.Title, "Are You Sure Want to Submit?", "OK", "Cancel", false, new AlertBox() {
                @Override
                            ...
                            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                if (response.isSuccessful()) {
                                    try {
                                        ...
                                        common_class.showMsg(CompementaryInvoiceActivity.this, jsonObjects.getString("Msg"));
    ...
    private void FilterProduct() {
        findViewById(R.id.rlCategoryItemSearch).setVisibility(View.GONE);
        findViewById(R.id.rl_reference_invoice_number).setVisibility(View.GONE);
        findViewById(R.id.rlSearchParent).setVisibility(View.GONE);
        ...
        mProdct_Adapter = new CompementaryInvoiceActivity.Prodct_Adapter(Getorder_Array_List, R.layout.complementary_invoice_pay_recyclerview_edit, getApplicationContext(), -1);
    ...
    void showFreeQtyList() {
        ...
        if (freeQty_Array_List != null && freeQty_Array_List.size() > 0) {
            ...
            CompementaryInvoiceActivity.Free_Adapter mFreeAdapter = new CompementaryInvoiceActivity.Free_Adapter(freeQty_Array_List, R.layout.product_free_recyclerview, getApplicationContext(), -1);
...
//        tvBillToPay.setText(CurrencySymbol + " " + formatter.format(totalvalues));
        tvcashdiscount.setText(CurrencySymbol + " " + formatter.format(totalvalues));
...
//                    common_class.showMsg(this, "Can't exceed Stock");
    ...
    void moveProductScreen() {
        ...
        findViewById(R.id.rl_reference_invoice_number).setVisibility(View.VISIBLE);
        findViewById(R.id.rlSearchParent).setVisibility(View.VISIBLE);
        findViewById(R.id.rlCategoryItemSearch).setVisibility(View.GONE);
    ...
    public class CategoryAdapter extends RecyclerView.Adapter<CompementaryInvoiceActivity.CategoryAdapter.MyViewHolder> {

        Context context;
        CompementaryInvoiceActivity.CategoryAdapter.MyViewHolder pholder;
        ...
        @Override
        public CompementaryInvoiceActivity.CategoryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(R.layout.category_order_horizantal_universe_gridview, parent, false);
            return new CompementaryInvoiceActivity.CategoryAdapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(CompementaryInvoiceActivity.CategoryAdapter.MyViewHolder holder, int position) {
            try {
    ...
    public class Prodct_Adapter extends RecyclerView.Adapter<CompementaryInvoiceActivity.Prodct_Adapter.MyViewHolder> {
        Context context;
        int CategoryType;
        ...
        @Override
        public CompementaryInvoiceActivity.Prodct_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
            return new CompementaryInvoiceActivity.Prodct_Adapter.MyViewHolder(view);
        }
                        ...
                        public void onClick(View v) {
                            ...
                            if (Product_Details_Modal.getUOMList() != null && Product_Details_Modal.getUOMList().size() > 0) {
                                for (int i = 0; i < Product_Details_Modal.getUOMList().size(); i++) {
                                    com.milksales.godairy.SFA_Model_Class.Product_Details_Modal.UOM uom = Product_Details_Modal.getUOMList().get(i);
                ...
                holder.QtyPls.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (balance >= order) {
                            ...
                            common_class.showMsg(CompementaryInvoiceActivity.this, "Can't exceed stock");
                        }
                    }
                });
...
//                                }
                ...
                if (CategoryType == -1) {
                    holder.ivDel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialogBox.showDialog(CompementaryInvoiceActivity.this, HAPApp.Title,
        ...
        private void showDialog(Product_Details_Modal product_details_modal) {
            try {
                ...
                LayoutInflater inflater = LayoutInflater.from(CompementaryInvoiceActivity.this);

                final View view = inflater.inflate(R.layout.edittext_price_dialog, null);
                AlertDialog alertDialog = new AlertDialog.Builder(CompementaryInvoiceActivity.this).create();
    ...
    public class Free_Adapter extends RecyclerView.Adapter<CompementaryInvoiceActivity.Free_Adapter.MyViewHolder> {
        Context context;
        private List<Product_Details_Modal> Product_Details_Modalitem;
        private int rowLayout;
        ...
        @Override
        public CompementaryInvoiceActivity.Free_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
            return new CompementaryInvoiceActivity.Free_Adapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(CompementaryInvoiceActivity.Free_Adapter.MyViewHolder holder, int position) {
            try {
