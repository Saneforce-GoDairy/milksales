package com.milksales.godairy.Status_Activity;
...
import com.milksales.godairy.Activity_Hap.ERT;
import com.milksales.godairy.Activity_Hap.Help_Activity;
import com.milksales.godairy.Activity_Hap.PayslipFtp;
...
import com.milksales.godairy.Status_Adapter.MissedPnch_Status_Adapter;
import com.milksales.godairy.Status_Model_Class.MissedPunch_Status_Model;
...
public class MissedPunch_Status_Activity extends AppCompatActivity {
    ...
    private void getMissedPunch() {
        ...
        Call<Object> mCall = apiInterface.GetTPObject1(i.getExtras().getString("AMod"),Shared_Common_Pref.Div_Code, Shared_Common_Pref.Sf_Code, Shared_Common_Pref.Sf_Code, Shared_Common_Pref.StateCode, "GetMissedPunch_Status", routemaster);
        mCall.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                recyclerView.setAdapter(new MissedPnch_Status_Adapter(missedPunchStatusModelList, R.layout.missed_punch_status_listitem, getApplicationContext(),AMOD));
            }
