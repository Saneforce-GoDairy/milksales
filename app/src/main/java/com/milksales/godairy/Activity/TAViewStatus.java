...
public class TAViewStatus extends AppCompatActivity implements Master_Interface,
    ...
    List<com.milksales.godairy.Model_Class.ModeOfTravel> modelOfTravel;
...
//                }
    ...
    public void submitData(String responseVal, CircularProgressButton btnAnim) {
        ...
        try {
            ...
            ResetSubmitBtn(0, btnAnim);
            AlertDialogBox.showDialog(TAViewStatus.this, HAPApp.Title, String.valueOf(Html.fromHtml("Can't submit your claim. <br> " + e.getMessage())), "OK", "", false, new AlertBox() {
                @Override
                public void PositiveMethod(DialogInterface dialog, int id) {
                    dialog.dismiss();
                }
