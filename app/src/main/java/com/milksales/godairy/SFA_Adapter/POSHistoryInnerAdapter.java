...
public class POSHistoryInnerAdapter extends RecyclerView.Adapter<POSHistoryInnerAdapter.MyViewHolder>{
    JSONArray jLists;
    int RowLayout;
    Context context;

    public POSHistoryInnerAdapter(JSONArray jList, int rowLayout, Context mcontext){
        jLists=jList;
        RowLayout=rowLayout;
        context = mcontext;
    }
    ...
    @NonNull
    @Override
    public POSHistoryInnerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(RowLayout, parent, false);
        return new POSHistoryInnerAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull POSHistoryInnerAdapter.MyViewHolder holder, int position) {
        try{
