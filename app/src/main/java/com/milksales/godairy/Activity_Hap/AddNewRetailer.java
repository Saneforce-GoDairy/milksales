...
import static com.milksales.godairy.Common_Class.Constants.CUSTOMER_DATA;
import static com.milksales.godairy.Common_Class.Constants.Freezer_Status;
import static com.milksales.godairy.Common_Class.Constants.Freezer_capacity;
import static com.milksales.godairy.Common_Class.Constants.OUTLET_CATEGORY;
...
import com.milksales.godairy.SFA_Adapter.FilesAdapter;
import com.milksales.godairy.SFA_Adapter.QPS_Modal;
import com.milksales.godairy.SFA_Model_Class.Retailer_Modal_List;
import com.milksales.godairy.common.DatabaseHandler;
import com.milksales.godairy.common.FileUploadService;
                ...
                public void onClick(View v) {
                    ...
                    if (cbFranchise.isChecked() && !isValidCode) {
                        if (btnDistCode.getText().toString().equalsIgnoreCase("Check Validity"))
                            ...
                            common_class.showMsg(AddNewRetailer.this, "Please give valid Franchise Code or uncheck \"" + HAPApp.Title + " Franchise\"");
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_dist_enter:
                    if (Shared_Common_Pref.Outler_AddFlag != null && !Shared_Common_Pref.Outler_AddFlag.equals("1")) {
                        ...
                        AlertDialogBox.showDialog(AddNewRetailer.this, HAPApp.Title, "Are You Sure Want to Update the Franchise Code?", "OK", "Cancel", false, new AlertBox() {
                            @Override
