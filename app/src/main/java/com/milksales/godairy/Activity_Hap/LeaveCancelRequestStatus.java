...
import com.milksales.godairy.Model_Class.LeaveCancelStatusModel;
import com.milksales.godairy.R;
import com.milksales.godairy.Status_Adapter.LeaveCancelStatusAdapter;
...
public class LeaveCancelRequestStatus extends AppCompatActivity {
    List<LeaveCancelStatusModel> HolidayApproval;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HolidayRecyclerStatus = findViewById(R.id.leave_cancel_status);
        HolidayRecyclerStatus.setLayoutManager(new LinearLayoutManager(this));
        common_class = new Common_Class(this);
        gson = new Gson();
        getLeaveCancelRequest();
    }
