...
import com.milksales.godairy.SFA_Activity.Invoice_History;
...
public class Invoice_Vansales_Select extends AppCompatActivity implements View.OnClickListener, UpdateResponseUI, Master_Interface {
    ...
    private void GetJsonData(String jsonResponse, String type, String filter) {
        ...
        try {
            ...
            if (type.equals("1")) {
                ...
                Invoice_Vansales_Select.CategoryAdapter customAdapteravail = new Invoice_Vansales_Select.CategoryAdapter(getApplicationContext(),
                        Category_Modal);
    ...
    private void SaveOrder() {
        if (common_class.isNetworkAvailable(this)) {
            ...
            AlertDialogBox.showDialog(Invoice_Vansales_Select.this, HAPApp.Title, "Are You Sure Want to Submit?", "OK", "Cancel", false, new AlertBox() {
                @Override
                        ...
                        responseBodyCall.enqueue(new Callback<JsonObject>() {
                            ...
                            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                                if (response.isSuccessful()) {
                                    try {
                                        common_class.ProgressdialogShow(0, "");
                                        Log.d("vanInvoiceJSON_VALUES", data.toString());
...
//                }
    ...
    public class CategoryAdapter extends RecyclerView.Adapter<Invoice_Vansales_Select.CategoryAdapter.MyViewHolder> {

        Context context;
        Invoice_Vansales_Select.CategoryAdapter.MyViewHolder pholder;
        ...
        @Override
        public Invoice_Vansales_Select.CategoryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(R.layout.category_order_horizantal_universe_gridview, parent, false);
            return new Invoice_Vansales_Select.CategoryAdapter.MyViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(Invoice_Vansales_Select.CategoryAdapter.MyViewHolder holder, int position) {
            try {
                ...
                if (CategoryType == -1) {
                    holder.ivDel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialogBox.showDialog(Invoice_Vansales_Select.this, HAPApp.Title,
...
//    private int uomPos;
//
////    TextView tvOtherBrand, tvQPS, tvPOP, tvCoolerInfo, tvRetailorPhone, tvDistname, retaileAddress, tvHeader;
//
////    LinearLayout lin_orderrecyclerview, lin_gridcategory, rlAddProduct, llCalMob;
////    private LinearLayout rlCredit, rlCash;
////    CheckBox cbCredit, cbCash;
////    EditText etCategoryItemSearch, etRecAmt;
////
////    Common_Class common_class;
...
////    private int uomPos;
////    private ArrayList<Common_Model> uomList;
////    private TextView tvPayMode, tvDate, tvOutStanding, tvTotOutstanding, tvInvAmt, tvPayAmt;
////    LinearLayout llPayMode;
////    RelativeLayout rlPayment;
////    String axn = "";
////    String orderId = "";
...
//        }
//        catch (Exception e) {
//            Log.v(TAG, " valsales invoice oncreate: " + e.getMessage());
//
//        }
//    }
//
...
//        takeorder.setText("SUBMIT");
//
//        mProdct_Adapter = new Prodct_Adapter(Getorder_Array_List, R.layout.vansales_product_pay_recyclerview, getApplicationContext(), -1);
//        recyclerView.setAdapter(mProdct_Adapter);
//        showFreeQtyList();
//
//
...
////                            String strSchemeList = sharedCommonPref.getvalue(Constants.FreeSchemeDiscList);
////
////                            Type type1 = new com.google.gson.reflect.TypeToken<ArrayList<Product_Details_Modal>>() {
////                            }.getType();
////                            List<Product_Details_Modal> product_details_modalArrayList = gson.fromJson(strSchemeList, type1);
////
////                            double highestScheme = 0;
...
//
//                            Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).setQty((int) enterQty);
//                            holder.Amount.setText("₹" + new DecimalFormat("##0.00").format(totQty * Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).getRate()));
//                            Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).setAmount(Double.valueOf(formatter.format(totQty *
//                                    Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).getRate())));
//                            if (CategoryType >= 0) {
//                                holder.QtyAmt.setText("₹" + formatter.format(enterQty * Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).getRate() * Product_Details_Modalitem.get(holder.getBindingAdapterPosition()).getCnvQty()));
//                                holder.totalQty.setText("Total Qty : " + (int) /*totQty*/enterQty);
//
//
//                            }
