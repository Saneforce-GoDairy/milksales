...
import com.milksales.godairy.Model_Class.Model;
...
import com.milksales.godairy.common.TimerService;
import com.milksales.godairy.databinding.ActivityLoginBinding;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (com.milksales.godairy.Common_Class.Common_Class.GetDatewothouttime().equalsIgnoreCase(shared_common_pref.getvalue(Constants.LOGIN_DATE))) {
...
//                                        }, 1000);
    ...
    void assignLoginData(Model response, int requestCode) {
        try {
            ...
            shared_common_pref.save(Constants.LOGIN_DATE, com.milksales.godairy.Common_Class.Common_Class.GetDatewothouttime());
